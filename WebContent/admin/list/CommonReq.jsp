...
<%@page import="org.inmogr.java.web.software.development.requirements.beans.CommonReqBean"%>
			...
			<div class="row">
				...
				<div class="col-2 text-right pr-3">
	                <div class="dropdown">
	                    ...
	                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
	                    	<a class="dropdown-item" href=<%=("\""+HTML.ADMIN_DIR+"/list"+"/VariableReq.jsp"+"\"")%>>List Variable Requirements</a>
