<%@page import="org.inmogr.java.web.software.development.requirements.beans.ListItemsBean"%>
<%@page import="org.inmogr.java.web.software.development.requirements.beans.VariableReqBean"%>
			...
			<div class="row">
				...
				<div class="col-2 text-right pr-3">
	                <div class="dropdown">
	                    ...
	                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
	                    	<a class="dropdown-item" href=<%=("\""+HTML.ADMIN_DIR+"/list"+"/CommonReq.jsp"+"\"")%>>List Common Requirements</a>
	                    	<a class="dropdown-item" href=<%=("\""+HTML.ADMIN_DIR+"/list"+"/Requirement.jsp"+"\"")%>>Back to Requirements</a>
	                    	<a class="dropdown-item" href=<%=("\""+HTML.ADMIN_DIR+"/list"+"/RequirementPattern.jsp"+"\"")%>>Back to Requirement Patterns</a>
	                    	<a class="dropdown-item" href=<%=("\""+HTML.ADMIN_DIR+"/print"+"\"")%>>Print</a>
	                    </div>
	                </div>
				</div>
					...
					<tr>
						...
						<td style="width: 10%;">
							<form method="post" action="VariableReq.jsp">
								<input type="hidden" name="requirementID" value=<%=("\""+dataList.getRequirementID()+"\"")%>>
								<input type="hidden" name="variableReqID" value=<%=("\""+dataList.getItem(index, listType, "id")+"\"")%>>
