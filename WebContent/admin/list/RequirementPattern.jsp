<%@page import="org.inmogr.java.web.software.development.requirements.beans.RequirementPatternBean"%>
	...
	if (!auth.isAuthenticated()) {
		...
		<div class="mx-5">
			...
			<table class="table table-striped table-bordered table-hover" id="dataTables-example">
				...
				<tbody>
				<%
				String listType = "RequirementPattern";
					...
					<tr>
						...
						<td style="width: 10%;">
							<form method="post" action="Solution.jsp">
								<input type="hidden" name="patternID" value=<%=("\""+dataList.getItem(index, listType, "id")+"\"")%>>
