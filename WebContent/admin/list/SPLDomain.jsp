<%@page import="org.inmogr.java.web.software.development.requirements.beans.SPLDomainBean"%>
					...
					<tr>
						...
						<td style="width: 10%;">
							<form method="post" action="RequirementPattern.jsp">
								<input type="hidden" name="SPLDomainName" value=<%=("\""+dataList.getItem(index, listType, "id")+"\"")%>>
