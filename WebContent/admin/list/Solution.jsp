<%@page import="org.inmogr.java.web.software.development.requirements.beans.SolutionBean"%>
			...
			<table class="table table-striped table-bordered table-hover" id="dataTables-example">
				...
				%>
					<tr>
						...
						<td style="width: 10%;">
							<form method="post" action="Requirement.jsp">
								<input type="hidden" name="solutionID" value=<%=("\""+dataList.getItem(index, listType, "id")+"\"")%>>
