...
public class RecordAdd {
	...
	public static JsonObject addRequirementPattern(RequirementPattern requirementPattern) {
		...
		insert.addValue("consideration_con_constraint", requirementPattern.getConsideration().getConConstraint());
		insert.addValue("consideration_con_description", requirementPattern.getConsideration().getConDescription());
		insert.addValue("consideration_con_purpose", requirementPattern.getConsideration().getConPurpose());
