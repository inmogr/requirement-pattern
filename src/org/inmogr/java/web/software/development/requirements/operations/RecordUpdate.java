...
public class RecordUpdate {
	...
	public static JsonObject updateRequirementPattern(RequirementPattern requirementPattern) {
		...
		update.addValue("consideration_for_design_con_constraint", requirementPattern.getConsiderationForDesign().getConConstraint());
		update.addValue("consideration_for_design_con_description", requirementPattern.getConsiderationForDesign().getConDescription());
		update.addValue("consideration_for_design_con_purpose", requirementPattern.getConsiderationForDesign().getConPurpose());
		update.addValue("consideration_for_design_design_pattern_name", requirementPattern.getConsiderationForDesign().getDesignPatternName());
		update.addValue("consideration_for_design_design_guide", requirementPattern.getConsiderationForDesign().getDesignGuide());
		update.addValue("consideration_for_development_con_constraint", requirementPattern.getConsiderationForDevelopment().getConConstraint());
		update.addValue("consideration_for_development_con_description", requirementPattern.getConsiderationForDevelopment().getConDescription());
		update.addValue("consideration_for_development_con_purpose", requirementPattern.getConsiderationForDevelopment().getConPurpose());
		update.addValue("consideration_for_development_dev_guide", requirementPattern.getConsiderationForDevelopment().getDevGuide());
		update.addValue("consideration_for_testing_con_constraint", requirementPattern.getConsiderationForTesting().getConConstraint());
		update.addValue("consideration_for_testing_con_description", requirementPattern.getConsiderationForTesting().getConDescription());
		update.addValue("consideration_for_testing_con_purpose", requirementPattern.getConsiderationForTesting().getConPurpose());
		update.addValue("consideration_for_testing_test_guide", requirementPattern.getConsiderationForTesting().getTestGuide());
		update.addValue("consideration_for_testing_test_type", requirementPattern.getConsiderationForTesting().getTestType());
